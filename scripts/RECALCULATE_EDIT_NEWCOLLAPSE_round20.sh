...
do
	...
	${python_version} ${bam_surgeon}/bed_compare9_redo_EDIT_RECALCULATE_NEWCOLLAPSE_round20.py $distance ${dir}/${run_ID}_${bam_name}_filter_results/ $TE_lengths ${run_ID}_${bam_name}_final_positions.bed ${run_ID}_${bam_name} $TE_consensus >& ${run_ID}_${bam_name}_bedcompare.log
