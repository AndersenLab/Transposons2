...
# this script runs round10 of the transposon simulations/detection
# USE: WB_SIM_round10_TransposonsBS_N2_SB_TTR.sh
...
all_WB_seqs=/lscr2/andersenlab/kml436/git_repos2/Transposons/files/SET2/MUTS/per.05_mut_WB_seqs
