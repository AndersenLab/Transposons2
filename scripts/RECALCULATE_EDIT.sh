...
# (runs bed_compare9_redo_EDIT_RECALCULATE)
# USE: RECALCUALTE.sh
# oR USE: RECALCULATE_EDIT <consensus_file> <length_file>
...
do
	...
	${python_version} ${bam_surgeon}/bed_compare9_redo_EDIT_RECALCULATE.py $distance ${dir}/${run_ID}_${bam_name}_filter_results/ $TE_lengths ${run_ID}_${bam_name}_final_positions.bed ${run_ID}_${bam_name} $TE_consensus >& ${run_ID}_${bam_name}_bedcompare.log
