...
TE_consensus=/lscr2/andersenlab/kml436/git_repos2/Transposons/files/round2_consensus_fasta.fasta
##ALTERNATE: TE_consensus=/lscr2/andersenlab/kml436/common.fasta
processors=18
TTR=/lscr2/andersenlab/kml436/git_repos2/mcclintock/
element_list=/lscr2/andersenlab/kml436/git_repos2/Transposons/files/fasta_list.txt
##ALTERNATE: element_list=/lscr2/andersenlab/kml436/sv_files/WB_REPB_elementlist.gff
location_list=/lscr2/andersenlab/kml436/git_repos2/Transposons/files/bed_list.txt
...
TE_lengths=/lscr2/andersenlab/kml436/git_repos2/Transposons/files/lengths.txt
...
${python_version} ${bam_surgeon}/bed_compare9_redo.py 20 ${dir}/${run_ID}_${bam_name}_non_filter_results/ $TE_lengths ${run_ID}_${bam_name}_final_positions.bed ${run_ID}_${bam_name} >& ${run_ID}_${bam_name}_bedcompare.log
...
cd ${run_ID}_${bam_name}_filter_results/
mkdir BEDCOMPARE_files
${python_version} ${bam_surgeon}/bed_compare9_redo.py 20 ${dir}/${run_ID}_${bam_name}_filter_results/ $TE_lengths ${run_ID}_${bam_name}_final_positions.bed ${run_ID}_${bam_name} >& ${run_ID}_${bam_name}_bedcompare.log
mv BEDCOMPARE_${run_ID}_${bam_name}.txt BEDCOMPARE_FAMILY_${run_ID}_${bam_name}.txt BEDCOMPARE_SUMMARY_${run_ID}_${bam_name}.txt BEDCOMPARE_files
cd BEDCOMPARE_files
