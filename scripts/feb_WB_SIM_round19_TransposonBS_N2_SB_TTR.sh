...
parent_dir=/lscr2/andersenlab/kml436/Feb_simulations/round20_Aug19/round19_Aug13
...
echo "copying over bam and final position files..."
cp ${parent_dir}/${run_ID}_${bam_name}/${run_ID}_${bam_name}.sorted.bam .
cp ${parent_dir}/${run_ID}_${bam_name}/${run_ID}_${bam_name}.sorted.bam.bai .
cp ${parent_dir}/${run_ID}_${bam_name}/${run_ID}_${bam_name}_final_positions.bed .
cp ${parent_dir}/${run_ID}_${bam_name}/${run_ID}_${bam_name}_final_positions_WB_copy.bed .
...
cat ${run_ID}_${bam_name}_retroseq_nonredundant.bed| sed s'/chrX/X/g'| sed '/^track/d' | awk '$4 ~/non-reference/ && $4 !~ /TC8/ && $1 !~ /MtDNA/ {print $0}'> ${bam_name}_temp && mv ${bam_name}_temp ${run_ID}_${bam_name}_retroseq_nonredundant.bed 
