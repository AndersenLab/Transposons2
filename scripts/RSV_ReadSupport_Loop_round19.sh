...
do
	...
	cat run_${run_ID}_N2_temp_nonredundant.bed | awk -v i=$i '$5>=i {print $0}' > tmp && mv tmp run_${run_ID}_N2_temp_nonredundant.bed

	python /lscr2/andersenlab/kml436/git_repos2/bamsurgeon/bed_compare9_redo_EDIT_RECALCULATE.py 20000000 ${dir}/run_${run_ID}_N2_filter_results/ $TE_lengths !ref_pos.bed! run_${run_ID} $consensus_renamed >& run_${run_ID}_bedcompare.log
