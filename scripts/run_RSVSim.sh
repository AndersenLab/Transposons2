...
bwa mem -t 24 -R '@RG\tID:B_N2\tSM:N2' new_genome_${run_ID}.fasta $B_N2_1 $B_N2_2 > B_N2.sam
bwa mem -t 24 -R '@RG\tID:C_N2\tSM:N2' new_genome_${run_ID}.fasta $C_N2_1 $C_N2_2 > C_N2.sam
bwa mem -t 24 -R '@RG\tID:D_N2\tSM:N2' new_genome_${run_ID}.fasta $D_N2_1 $D_N2_2 > D_N2.sam
bwa mem -t 24 -R '@RG\tID:E_N2\tSM:N2' new_genome_${run_ID}.fasta $E_N2_1 $E_N2_2 > E_N2.sam
bwa mem -t 24 -R '@RG\tID:F_N2\tSM:N2' new_genome_${run_ID}.fasta $F_N2_1 $F_N2_2 > F_N2.sam
bwa mem -t 24 -R '@RG\tID:G_N2\tSM:N2' new_genome_${run_ID}.fasta $G_N2_1 $G_N2_2 > G_N2.sam
bwa mem -t 24 -R '@RG\tID:H_N2\tSM:N2' new_genome_${run_ID}.fasta $H_N2_1 $H_N2_2 > H_N2.sam
bwa mem -t 24 -R '@RG\tID:I_N2\tSM:N2' new_genome_${run_ID}.fasta $I_N2_1 $I_N2_2 > I_N2.sam
#SAMTOOLS VIEW
...
/opt/samtools/x64/samtools/samtools sort -@ 24 -O bam -T tmp3 D_N2.unsorted.bam > D_N2.sorted.bam
/opt/samtools/x64/samtools/samtools sort -@ 24 -O bam -T tmp3 E_N2.unsorted.bam > E_N2.sorted.bam
/opt/samtools/x64/samtools/samtools sort -@ 24 -O bam -T tmp3 F_N2.unsorted.bam > F_N2.sorted.bam
/opt/samtools/x64/samtools/samtools sort -@ 24 -O bam -T tmp3 G_N2.unsorted.bam > G_N2.sorted.bam
/opt/samtools/x64/samtools/samtools sort -@ 24 -O bam -T tmp3 H_N2.unsorted.bam > H_N2.sorted.bam
/opt/samtools/x64/samtools/samtools sort -@ 24 -O bam -T tmp3 I_N2.unsorted.bam > I_N2.sorted.bam
