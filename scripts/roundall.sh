...
round20_dir=/lscr2/andersenlab/kml436/round20_Aug19/round19_Aug13
...
echo "Copying Over BAM files..."
cp ${round20_dir}/${run_ID}_${bam_name}/${run_ID}_${bam_name}.sorted.bam .
cp ${round20_dir}/${run_ID}_${bam_name}/${run_ID}_${bam_name}.sorted.bam.bai .
