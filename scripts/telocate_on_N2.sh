...
# this script runs TELOCATE on N2  (used to determien how well the TELCOATE finds the reference transposons in a sample without transposon simulation)
# USE: telocate_on_N2.sh <run_number>
...
cp -s $bam ${run_ID}_${bam_name}.sorted.bam
cp -s ${bam}.bai ${run_ID}_${bam_name}.sorted.bam.bai
