...
# outputs:
# 1) files containing all contradictory calls for the runs (bed info)
# 2) summary files in order of: run, total number of contradictory calls, total reference calls, and total absence calls
# USE: temp_telocate_compatibility.py <data directory> <run_list file>

import sys
import re
from subprocess import Popen, PIPE

data_dir= sys.argv[1]#"/lscr2/andersenlab/kml436/RSV_simulations_Aug31_tenth"
sample_list= sys.argv[2]#"/lscr2/andersenlab/kml436/git_repos2/Transposons2/files/run_list.txt"
...
for line in SAMPLE_LIST:
	...
	telocate="{data_dir}/{strain}/{strain}_filter_results_temp/intermediates_RECALCULATED/new_CT_{strain}_temp_nonredundant.bed".format(**locals())
	temp="{data_dir}/{strain}/{strain}_filter_results_telocate/intermediates_RECALCULATED/new_CT_{strain}_telocate_nonredundant.bed".format(**locals())
